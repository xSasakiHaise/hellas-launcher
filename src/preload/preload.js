...
contextBridge.exposeInMainWorld('hellas', {
  ...
  setActiveProfile: (profileId) => ipcRenderer.invoke('hellas:set-active-profile', profileId),
  getAdditionalMods: () => ipcRenderer.invoke('hellas:get-additional-mods'),
  setAdditionalMods: (links) => ipcRenderer.invoke('hellas:set-additional-mods', links),
  ...
  reinstallProfileJava: () => ipcRenderer.invoke('hellas:reinstall-profile-java'),
